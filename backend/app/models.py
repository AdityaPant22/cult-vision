...
class Recording(Base):
    ...
    weight_kg: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    ...
    ai_feedback_json: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)
    live_rep_count: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
